 ...
 *
 * Run on its own:
 *   npx tsx src/fit/util/aws/warn-existing-instances.ts [--region eu-west-1]
 */
import { isMain, runCli } from "../../../util/non-fit/cli.js";
import { logAwsAction, prepareAwsCli, resolveRegion, type AwsOptions } from "../../../util/non-fit/aws/aws-cli.js";
