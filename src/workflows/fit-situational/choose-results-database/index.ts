 ...
 *   npx tsx src/workflows/fit-situational/choose-results-database/index.ts
 */
...
import { type ResultsDatabase } from "../situational-config.js";
import { setupLocalDatabase } from "../setup-local-database/index.js";
