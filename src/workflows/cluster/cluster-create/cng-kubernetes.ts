 ...
 *   npx tsx src/workflows/cluster/cluster-create/cng-kubernetes.ts check-local
 *   # Print the k8s block fit-cli uploads to a remote box for a given home dir:
 *   npx tsx src/workflows/cluster/cluster-create/cng-kubernetes.ts remote-block /home/ubuntu
 */
