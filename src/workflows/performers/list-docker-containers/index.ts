 ...
 *
 * Run on its own:
 *   npx tsx src/workflows/performers/list-docker-containers/index.ts java
 *   npx tsx src/workflows/performers/list-docker-containers/index.ts --url https://github.com/couchbase/couchbase-jvm-clients/pkgs/container/java-fit-performer --compact
 *   npx tsx src/workflows/performers/list-docker-containers/index.ts --help
 */
...
function usage(): string {
  return [
    "Usage:",
    "  tsx src/workflows/performers/list-docker-containers/index.ts [<sdk>]",
    "  tsx src/workflows/performers/list-docker-containers/index.ts --url <ghcr-url>[,<ghcr-url>...] [--json] [--compact] [--limit N]",
    "",
    "Examples:",
    "  tsx src/workflows/performers/list-docker-containers/index.ts java",
    "  tsx src/workflows/performers/list-docker-containers/index.ts --url https://github.com/couchbase/couchbase-jvm-clients/pkgs/container/java-fit-performer --compact",
  ].join("\n");
}
