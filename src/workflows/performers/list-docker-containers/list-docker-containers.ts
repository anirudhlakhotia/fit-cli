 ...
 *
 * Run on its own:
 *   npx tsx src/workflows/performers/list-docker-containers/list-docker-containers.ts java
 *   npx tsx src/workflows/performers/list-docker-containers/list-docker-containers.ts --url https://github.com/couchbase/couchbase-jvm-clients/pkgs/container/java-fit-performer --compact
 *   npx tsx src/workflows/performers/list-docker-containers/list-docker-containers.ts --help
 */
